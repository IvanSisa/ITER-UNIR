      ...
      <main>
        <section>
            ...
            <div class="article__footer">
              <div class="article__footer__items">
                <div class="article__footer__items__text">
                  <h4 class="article__footer__items__text__title">BOOTCAMP</h4>
                  <p class="article__footer__items__text__time">6 meses</p>
                  <p class="article__footer__items__text__data">Inicio: OCT</p>
                </div>
          ...
          <article class="article green">
            ...
            <div class="article__footer">
              <div class="article__footer__items">
                <div class="article__footer__items__text">
                  <h4 class="article__footer__items__text__title">MASTER FP</h4>
                  <p class="article__footer__items__text__time">6 meses</p>
                  <p class="article__footer__items__text__data">Inicio: OCT</p>
                </div>
                <div class="article__footer__items__icon">
          ...
          <article class="article yellow">
            <div class="article__body">
              ...
              <div class="article__body__text">
                <p class="article__body__text__text">
                    Configura, administra y mantiene sistemas informáticos. Con perfil en ciberseguridad.
                </p>
              </div>
            </div>
            <div class="article__footer">
              <div class="article__footer__items">
                <div class="article__footer__items__text">
                  <h4 class="article__footer__items__text__title">GRADO FP</h4>
                  <p class="article__footer__items__text__time">6 meses</p>
                  <p class="article__footer__items__text__data">Inicio: OCT</p>
                </div>
                <div class="article__footer__items__icon">
          ...
          <article class="article purple">
            <div class="article__body">
              <div class="article__body__title">
                ...
                <div class="article__body__title__icon">
                    <svg width="40" height="39" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M28.4315 13.6124H12.0195V30.0244H28.4315V13.6124Z" stroke="#918BFF" stroke-miterlimit="10"/>
                        <path d="M14.873 13.6124C14.9426 12.2397 15.5368 10.9463 16.5329 9.99938C17.529 9.05245 18.8509 8.52441 20.2252 8.52441C21.5996 8.52441 22.9215 9.05245 23.9176 9.99938C24.9137 10.9463 25.5079 12.2397 25.5774 13.6124" stroke="#918BFF" stroke-miterlimit="10"/>
                        </g>
                        <rect x="1.45117" y="0.5" width="37.5488" height="37.5488" stroke="#918BFF"/>
                        <defs>
                        <clipPath id="clip0_601_2957">
                        <rect width="22.5488" height="22.5488" fill="white" transform="translate(8.95117 8)"/>
                        </clipPath>
                        </defs>
                        </svg>
              ...
              <div class="article__body__text">
                <p class="article__body__text__text">
                    Descubre cómo montar tu propio ecommerce y especialízate en habilidades como Shopify, logística o gestión del surtido
                </p>
              </div>
            </div>
            <div class="article__footer">
        ...
        <section id="second-section">
            <article class="article purple">
                <div class="article__body">
                  <div class="article__body__title">
                    <h3 class="article__body__title__title">Gestor de Tiendas Online con Shopify</h3>
                    <div class="article__body__title__icon">
                        <svg width="40" height="39" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_601_2957)">
                            <path d="M28.4315 13.6124H12.0195V30.0244H28.4315V13.6124Z" stroke="#918BFF" stroke-miterlimit="10"/>
                  ...
                  <div class="article__body__text">
                    <p class="article__body__text__text">
                        Construye y gestiona una tienda online desde cero con Shopify, la plataforma líder en el sector, y diferentes pasarelas de pago.
                    </p>
                  </div>
                </div>
                <div class="article__footer">
            ...
            <article class="article yellow">
                <div class="article__body">
                  <div class="article__body__title">
                    <div class="article__body__title__text">
                      <h3 class="article__body__title__title">Marketing y Publicidad</h3>
                  ...
                  <div class="article__body__text">
                    <p class="article__body__text__text">
                        Diseña e implementa estrategias de marketing para todo tipo de empresas. Con perfil en Growth Marketing.
                    </p>
                  </div>
                </div>
                <div class="article__footer">
            ...
            <article class="article purple">
                <div class="article__body">
                  ...
                  <div class="article__body__text">
                    <p class="article__body__text__text">
                        Fórmate con el curso de Growth Marketing para mejorar el rendimiento digital de una marca o producto en tiempo récord.
                    </p>
                  </div>
                </div>
                <div class="article__footer">
        ...
        <button id="first-button" onclick="openSection()">Ver más</button>
        <button id="second-button" onclick="closeSection()">Ver menos</button>
      </main>
    </div>
    </>
  )
